...
- changed the downloads to make it so that instead of going to Codeberg Dot-files it goes to the new repo [here](https://github.com/El3ctricFX/Dot-Files) no GitHub
